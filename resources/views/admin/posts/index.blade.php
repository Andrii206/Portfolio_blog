            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-2 mb-3">
                        <a href="{{ route('admin.post.create') }}" class="btn btn-block btn-primary w-10">Створити</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                @foreach($posts as $post)
                                    <tr>
                                        ...
                                        <td>    
                                            <a href="{{ route('admin.post.edit', $post->id) }}"><i class="bi bi-pencil fa-lg mx-3 text-success"></i></a>
                                        </td>
                                        <td>
