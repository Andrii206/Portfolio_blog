        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <ul class="nav nav-actions d-lg-none ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#!" data-toggle="offCanvasMenu">
                        <img src="{{ asset('assets/images/socialicon@2x.svg') }}" alt="social-nav-toggle">
                    </a>
                </li>
            </ul>
            ...
            <div class="collapse navbar-collapse" id="oleezMainNav">
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('post.popular-posts') }}">Популярні пости<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('personal.main.index') }}">Війти<span class="sr-only">(current)</span></a>
                    </li>
                </ul>
